...
public class MedicalProcedure extends AbstractMedicalPurpose {
    public MedicalProcedure(String title, String description, int patientId, int doctorId) {
        super(title, description, patientId, doctorId);
    }

    public MedicalProcedure(int id, String title, String description, MedicalPurposeStatus status, int patientId,
            int doctorId) {
